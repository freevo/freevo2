#!/usr/bin/env python
#
# dagenstv2xmltv v0.8 by Per Wigren <wigren@open-source.nu>
#
...
try:
	...
	print "Usage:", sys.argv[0], "<days> <lang> <filename>"
...
# Main program ;-)
writexml( unicode(create_xml(program),'latin-1').encode("utf-8") )
